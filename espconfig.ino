...
//------- WI-FI details ----------//
char ssid[] = "Jarvis"; // SSID here
char pass[] = "onetwonine"; // Passowrd here
//--------------------------------//

//----------- Channel details ----------------//
unsigned long Channel_ID = "2184350"; // Channel ID
const char * myWriteAPIKey = "BDO6085NXGJP8X7A"; //Your write API key
//-------------------------------------------//
